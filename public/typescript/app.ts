import {urlserver,ISan_Pham,CSan_Pham  } from "./common.js";

export const layqua =async (sosp:number = 8)=>{
...
export const getCate = async (id_cate:number) =>{
...
export const getPro = async(id:number = 0)=>{
